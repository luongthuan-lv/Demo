...
public class NgayChiAdapter extends RecyclerView.Adapter<ThuHolder> {
    public Context context;
    public List<Chi> chiList;
    public vn.edu.poly.demo.database_two.chiDao chiDao;
    public AlertDialog alertDialog;

    public NgayChiAdapter(Context context, List<Chi> chiList) {
    ...
    public void onBindViewHolder(@NonNull final ThuHolder thuHolder, final int position) {
        ...
        thuHolder.tvName.setText(chi.NgayChi);
