...
public class NgayThuAdapter extends RecyclerView.Adapter<ThuHolder> {
    public Context context;
    public List<Thu> thuList;
    public vn.edu.poly.demo.database_one.thuDao thuDao;
    public AlertDialog alertDialog;

    public NgayThuAdapter(Context context, List<Thu> thuList) {
    ...
    public void onBindViewHolder(@NonNull final ThuHolder thuHolder, final int position) {
        ...
        thuHolder.tvName.setText(thu.NgayThu);
                ...
                btnAdd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            Date d = sdf.parse(ten);

                        } catch (Exception e) {
                            Toast.makeText(context, "Vui lòng nhập ngày là số và theo đúng định dạng dd/mm/yyyy", Toast.LENGTH_SHORT).show();
                            return;
                        }
